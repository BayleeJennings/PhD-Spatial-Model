...
var style_PredictedSpeciesRichness_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Predicted Richness");
    ...
    if (value >= 0.040000 && value <= 4.303333) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.303333 && value <= 8.566667) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 8.566667 && value <= 12.830000) {
            style = [ new ol.style.Style({
