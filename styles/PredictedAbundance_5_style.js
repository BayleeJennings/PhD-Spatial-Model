...
var style_PredictedAbundance_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Predicted Abundance");
    ...
    if (value >= 0.010000 && value <= 50.010000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 50.010000 && value <= 100.010000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 100.010000 && value <= 300.000000) {
            style = [ new ol.style.Style({
